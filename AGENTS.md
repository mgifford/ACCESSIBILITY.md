...
For global installation of this project's accessibility guidance as an AI agent skill, see [`ACCESSIBILITY.skill`](./ACCESSIBILITY.skill) in the repository root.
